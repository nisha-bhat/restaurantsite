<section class="fnavbar">
		...
		<nav>
		    <div class="nav-wrapper">
		      <a href="#" class="brand-logo">AllFoods</a>
		      <a href="#" data-target="mobile-demo" class="sidenav-trigger"><i class="material-icons">menu</i></a>
		      <ul class="right hide-on-med-and-down">
		        <li><a href="/AllFoods" class="hvr-grow">Home</a></li>
		        <li><a href="/AllFoods/about-all-foods.php" class="hvr-grow">About Us</a></li>
		  ...
		  <ul class="sidenav" id="mobile-demo">
		    <li><a href="/AllFoods">Home</a></li>
	        <li><a href="/AllFoods/about-all-foods.php">About Us</a></li>
